...
(cl:defmethod cl:initialize-instance :after ((m <planning_cmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'planning_cmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clips_ros-srv:<planning_cmd-request> is deprecated: use clips_ros-srv:planning_cmd-request instead.")))

(cl:ensure-generic-function 'params-val :lambda-list '(m))
(cl:defmethod params-val ((m <planning_cmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clips_ros-srv:params-val is deprecated.  Use clips_ros-srv:params instead.")
  (params m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <planning_cmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clips_ros-srv:name-val is deprecated.  Use clips_ros-srv:name instead.")
  (name m))
...
(cl:defmethod cl:initialize-instance :after ((m <planning_cmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'planning_cmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clips_ros-srv:<planning_cmd-response> is deprecated: use clips_ros-srv:planning_cmd-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <planning_cmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clips_ros-srv:success-val is deprecated.  Use clips_ros-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'args-val :lambda-list '(m))
(cl:defmethod args-val ((m <planning_cmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clips_ros-srv:args-val is deprecated.  Use clips_ros-srv:args instead.")
  (args m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<planning_cmd-response>)))
  ...
  "clips_ros/planning_cmdResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'planning_cmd-response)))
  "Returns string type for a service object of type 'planning_cmd-response"
  "clips_ros/planning_cmdResponse")
