...
(cl:defmethod cl:initialize-instance :after ((m <InitKDB-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InitKDB-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clips_ros-srv:<InitKDB-request> is deprecated: use clips_ros-srv:InitKDB-request instead.")))

(cl:ensure-generic-function 'filePath-val :lambda-list '(m))
(cl:defmethod filePath-val ((m <InitKDB-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clips_ros-srv:filePath-val is deprecated.  Use clips_ros-srv:filePath instead.")
  (filePath m))

(cl:ensure-generic-function 'run-val :lambda-list '(m))
(cl:defmethod run-val ((m <InitKDB-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clips_ros-srv:run-val is deprecated.  Use clips_ros-srv:run instead.")
  (run m))
...
(cl:defmethod cl:initialize-instance :after ((m <InitKDB-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InitKDB-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clips_ros-srv:<InitKDB-response> is deprecated: use clips_ros-srv:InitKDB-response instead.")))
