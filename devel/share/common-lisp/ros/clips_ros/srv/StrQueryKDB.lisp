...
(cl:defmethod cl:initialize-instance :after ((m <StrQueryKDB-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StrQueryKDB-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clips_ros-srv:<StrQueryKDB-request> is deprecated: use clips_ros-srv:StrQueryKDB-request instead.")))

(cl:ensure-generic-function 'query-val :lambda-list '(m))
(cl:defmethod query-val ((m <StrQueryKDB-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clips_ros-srv:query-val is deprecated.  Use clips_ros-srv:query instead.")
  (query m))
...
(cl:defmethod cl:initialize-instance :after ((m <StrQueryKDB-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StrQueryKDB-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clips_ros-srv:<StrQueryKDB-response> is deprecated: use clips_ros-srv:StrQueryKDB-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <StrQueryKDB-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clips_ros-srv:result-val is deprecated.  Use clips_ros-srv:result instead.")
  (result m))
