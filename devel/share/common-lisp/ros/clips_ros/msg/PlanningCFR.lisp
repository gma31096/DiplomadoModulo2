...
(cl:defclass <PlanningCFR> (roslisp-msg-protocol:ros-message)
  ((command
   ...
   (params
    :reader params
    :initarg :params
    :type (cl:vector clips_ros-msg:CFRParams)
   :initform (cl:make-array 0 :element-type 'clips_ros-msg:CFRParams :initial-element (cl:make-instance 'clips_ros-msg:CFRParams))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PlanningCFR>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanningCFR)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clips_ros-msg:<PlanningCFR> is deprecated: use clips_ros-msg:PlanningCFR instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <PlanningCFR>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clips_ros-msg:command-val is deprecated.  Use clips_ros-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'params-val :lambda-list '(m))
(cl:defmethod params-val ((m <PlanningCFR>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clips_ros-msg:params-val is deprecated.  Use clips_ros-msg:params instead.")
  (params m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PlanningCFR>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'params)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'clips_ros-msg:CFRParams))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PlanningCFR>)))
  ...
  (cl:format cl:nil "string command~%CFRParams[] params~%~%================================================================================~%MSG: clips_ros/CFRParams~%string frame_id~%string frame_value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PlanningCFR)))
  "Returns full string definition for message of type 'PlanningCFR"
  (cl:format cl:nil "string command~%CFRParams[] params~%~%================================================================================~%MSG: clips_ros/CFRParams~%string frame_id~%string frame_value~%~%~%"))
