...
(cl:defmethod cl:initialize-instance :after ((m <PlanningCmdSend>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanningCmdSend)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clips_ros-msg:<PlanningCmdSend> is deprecated: use clips_ros-msg:PlanningCmdSend instead.")))
