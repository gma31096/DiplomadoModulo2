...
message(STATUS "simulator: 1 messages, 1 services")
...
get_filename_component(_filename "/home/diego/catkin_ws/src/simulator/srv/robot_step.srv" NAME_WE)
add_custom_target(_simulator_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "simulator" "/home/diego/catkin_ws/src/simulator/srv/robot_step.srv" ""
)
...
_generate_srv_cpp(simulator
  "/home/diego/catkin_ws/src/simulator/srv/robot_step.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/simulator
)
